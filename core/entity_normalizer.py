...
class PartNormalizer:
    ...
    def normalize_part_name(self, part_name: str, part_code: Optional[str] = None) -> str:
        """
    ...
    def extract_metadata(self, part_name: str, part_code: Optional[str] = None) -> Dict[str, str]:
        """
    ...
    def validate_extraction(self, part_name: str, part_code: Optional[str] = None) -> Tuple[bool, list]:
        """
        ...
        if metadata['side'] == 'UNKNOWN' and metadata['part_type'] in ['HEADLAMP', 'FENDER', 'MIRROR']:
            issues.append("Could not identify side for part that typically has left/right variants")
