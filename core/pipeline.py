...
class ScrapingPipeline:
    ...
    def normalize_part_metadata(self, part: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not is_valid:
                warning_msg = f"Part {part['part_id']} normalization issues: {', '.join(issues)}"
    ...
    async def scrape_part_offers(self, scraper: TorobScraper, part: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
    ...
    def normalize_offer_prices(self, offers: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
    ...
    async def run_pipeline(self) -> bool:
        ...
        try:
            ...
            deduplicated_offers = self.deduplicator.deduplicate_offers(normalized_offers)
            ...
            unique_sellers = set(offer.get('seller_name_norm', '') for offer in deduplicated_offers)
