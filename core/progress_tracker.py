...
class ProgressTracker:
    ...
    def _update_display(self):
        ...
        with self._lock:
            ...
            # Create progress bar
            bar_length = 30
            filled_length = int(bar_length * total_processed // self.total_tasks) if self.total_tasks > 0 else 0
    ...
    def update_task(self, task_description: str, task_id: str = None, details: str = None):
        """
    ...
    def add_subtask(self, parent_task_id: str, subtask_description: str, subtask_id: str = None):
        """
    ...
    def finish(self, final_message: str = "Completed!"):
        ...
        if self.start_time:
            ...
            print(self._colorize(f"   Completed: {self.completed_tasks}/{self.total_tasks}", "dim"))
            print(self._colorize(f"   Failed: {self.failed_tasks}", "dim"))
            print(self._colorize(f"   Total Time: {self._format_time(total_time)}", "dim"))
            
            if self.completed_tasks > 0:
                avg_time = total_time / self.completed_tasks
                print(self._colorize(f"   Average per task: {self._format_time(avg_time)}", "dim"))
        else:
            print(self._colorize(f"✅ {final_message}", "green"))
