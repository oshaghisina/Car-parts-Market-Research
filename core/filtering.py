...
class RelevanceFilter:
    ...
    def __init__(self):
        ...
        self.negative_patterns = {
            'rear_lights': [
                r'چراغ عقب', r'چراغ پشت', r'tail light', r'taillight', r'rear light',
                r'چراغ ترمز', r'brake light', r'stop light'
            ],
            'fog_lights': [
                r'مه‌شکن', r'مه شکن', r'fog light', r'foglamp', r'چراغ مه',
                r'چراغ مه‌شکن', r'چراغ مه شکن'
            ],
            'drl_lights': [
                r'چراغ روز', r'چراغ روشنایی روز', r'daylight', r'drl', r'day running',
                r'چراغ روشنایی', r'led strip'
            ],
            'indicators': [
                r'راهنما', r'چراغ راهنما', r'indicator', r'turn signal', r'blinker',
                r'چراغ چشمک زن', r'چراغ هشدار'
            ],
            'side_mirrors': [
                r'آینه', r'آیینه', r'mirror', r'side mirror', r'wing mirror',
                r'آینه جانبی', r'آینه کناری'
            ],
            'interior_parts': [
                r'داخل', r'interior', r'کابین', r'cabin', r'صندلی', r'seat',
                r'داشبورد', r'dashboard', r'کنسول', r'console'
            ]
        }
        ...
        self.positive_patterns = {
            'front_bumper': [
                r'سپر جلو', r'بامپر جلو', r'front bumper', r'bumper front',
                r'سپر جلو', r'بامپر جلو'
            ],
            'headlamp': [
                r'چراغ جلو', r'headlight', r'headlamp', r'چراغ جلو',
                r'چراغ اصلی', r'main light'
            ],
            'front_fender': [
                r'گلگیر جلو', r'fender front', r'front fender', r'wing front',
                r'گلگیر جلو', r'فندر جلو'
            ],
            'hood': [
                r'کاپوت', r'hood', r'bonnet', r'کاپوت', r'سقف موتور'
            ],
            'grille': [
                r'جلوپنجره', r'grille', r'گریل', r'جلو پنجره', r'radiator grille',
                r'جلوپنجره', r'شبکه جلو'
            ]
        }
    ...
    def _calculate_relevance_score(self, title: str, query: str, attributes: Dict[str, str]) -> float:
        """
    ...
    def filter_and_score_result(self, title: str, query: str) -> Tuple[bool, float, Dict[str, str]]:
        """
    ...
    def filter_search_results(self, results: List[Dict[str, Any]], query: str) -> List[Dict[str, Any]]:
        """
        ...
        for result in results:
            ...
            is_valid, relevance_score, attributes = self.filter_and_score_result(title, query)
            ...
            if is_valid:
                ...
                result['part_name_norm'] = ' '.join(part_name_parts) if part_name_parts else title
